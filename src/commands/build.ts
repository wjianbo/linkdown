...
import type { BuildReports } from "../types.js";

export async function runBuildCommand(inputDir: string, outputDir: string): Promise<void> {
...
async function writeReport(outputPath: string, data: Record<string, string[]>): Promise<void> {
